...
import { Platform ,Text, StyleSheet, View, SafeAreaView, TextInput, StatusBar, ScrollView, Image, Dimensions, Animated } from 'react-native'
          ...
          <Animated.View style={{height: this.animatedHeaderHeight, backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#ddd'}}>
            <View style={{ 
              ...
              <TextInput
                ...
                style={{ flex: 1, marginLeft: 10, fontWeight: '700', backgroundColor: 'white' }}
              />
            </View>
            <Animated.View
          ...
          >
            <View style={{ flex: 1, backgroundColor: 'white', paddingTop: 20 }}>
              <Text style={{fontSize: 24, fontWeight: '700', paddingHorizontal: 20}}>
                What can we help you find, Ruby?
              </Text>
              <View style={{ height: 130, marginTop: 20}}>
                ...
                >
                  ...
                  <Category imageUri={require('../assets/3cb84d5de68ece124b637aa22d364736.png')} name='Home' />
                  <Category imageUri={require('../assets/home.jpg')} name='Home' />
                  <Category imageUri={require('../assets/home.jpg')} name='Home' />
                </ScrollView>
              </View>
